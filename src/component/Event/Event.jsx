    ...
    return (
        <div>
            <h2 className='text-3xl text-center font-bold m-12'>
                Our memorable event for our dedicated client
            </h2>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
               <img src="https://i.ibb.co/19VKkyz/austin-distel-rxp-Th-Owu-Vg-E-unsplash.jpg" alt="" />
               <img src="https://i.ibb.co/Kb8SLw7/marc-babin-ec-GZWPOvya0-unsplash.jpg" alt="" />
               ...
               <img src="https://i.ibb.co/KwRPyQd/wout-vanacker-l4-HBYk-URqv-E-unsplash.jpg" alt="" />
